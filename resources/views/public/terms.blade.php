<x-public-layout title="Syarat & Ketentuan - {{ config('app.name') }}">
    <section class="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-extrabold text-slate-900 sm:text-4xl dark:text-slate-100">Syarat &amp; Ketentuan</h1>
        ...
        <div class="mt-8 space-y-6 leading-relaxed text-slate-600 dark:text-slate-400">
            ...
            <p>
                ...
                kami melalui halaman <a href="{{ route('faq') }}" class="font-semibold text-primary-600 underline dark:text-primary-400">FAQ</a>.
            </p>
        </div>
    </section>
</x-public-layout>
