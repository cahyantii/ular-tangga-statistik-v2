<x-admin-layout>
    <h1 class="mb-6 text-2xl font-bold text-slate-900">Tambah Materi</h1>

    <form method="POST" action="{{ route('admin.management.materi.store') }}" class="max-w-2xl space-y-4 rounded-2xl border border-slate-200 bg-white p-6">
        @csrf
