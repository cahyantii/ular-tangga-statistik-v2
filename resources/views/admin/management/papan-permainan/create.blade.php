<x-admin-layout>
    <h1 class="mb-6 text-2xl font-bold text-slate-900">Tambah Papan Permainan</h1>

    <form method="POST" action="{{ route('admin.management.papan-permainan.store') }}" class="max-w-xl space-y-4 rounded-2xl border border-slate-200 bg-white p-6">
        @csrf
