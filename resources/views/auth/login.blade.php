...
>
    <x-slot:heroMobile>
        <h1 class="text-[32px] font-bold leading-tight text-slate-900 dark:text-dark-text">Selamat Datang Kembali!</h1>
    ...
    <div class="mx-auto w-full max-w-[520px] rounded-[28px] bg-white dark:bg-dark-surface p-5 shadow-[0_20px_60px_-15px_rgba(15,23,42,0.15)] md:p-8 lg:p-12">
        <div class="text-center">
            <img
                ...
                loading="lazy"
            >
            <h1 class="mt-5 text-2xl font-bold text-slate-900 dark:text-dark-text">Masuk ke Akunmu</h1>
            <p class="mt-1.5 text-sm text-slate-500 dark:text-dark-muted">Gunakan email dan password untuk masuk</p>
        </div>
        ...
        >
            ...
            <div class="flex items-center justify-between">
                <label for="remember_me" class="flex items-center gap-2 text-sm text-slate-600 dark:text-dark-muted">
                    <input
                        id="remember_me"
                        type="checkbox"
                        name="remember"
                        class="h-4 w-4 rounded border-slate-300 text-blue-700 focus:ring-blue-200 dark:border-dark-border dark:bg-dark-bg dark:checked:bg-blue-600 dark:focus:ring-offset-dark-surface"
                    >
                    Ingat saya
                </label>

                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="text-sm font-semibold text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                        Lupa password?
                    </a>
                @endif
            </div>
            ...
            <div class="relative py-1 text-center">
                <span class="relative z-10 bg-white dark:bg-dark-surface px-3 text-xs text-slate-400 dark:text-dark-muted">atau masuk dengan</span>
