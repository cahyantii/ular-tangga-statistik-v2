...
>
    <x-slot:heroMobile>
        <h1 class="text-[32px] font-bold leading-tight text-slate-900 dark:text-dark-text">Ayo Bergabung!</h1>

        <p class="mx-auto mt-2 max-w-xs text-sm text-slate-500 dark:text-dark-muted">
    ...
    <x-slot:hero>
        <h1 class="text-[40px] font-bold leading-tight text-slate-900 dark:text-dark-text lg:text-5xl">
            Buat Akun Baru
        </h1>

        <p class="mt-5 max-w-md text-xl text-slate-500 dark:text-dark-muted">
    ...
    <div class="mx-auto w-full max-w-[520px] rounded-[28px] bg-white dark:bg-dark-surface p-5 shadow-[0_20px_60px_-15px_rgba(15,23,42,0.15)] md:p-8 lg:p-12">
        <div class="text-center">
            <img
                ...
                loading="lazy"
            >
            <h1 class="mt-5 text-2xl font-bold text-slate-900 dark:text-dark-text">Buat Akun Baru</h1>
            <p class="mt-1.5 text-sm text-slate-500 dark:text-dark-muted">Isi data di bawah untuk membuat akun baru</p>
        </div>
        ...
        >
            ...
            />
            <p id="password-hint" class="-mt-3 text-xs text-slate-400 dark:text-dark-muted">Minimal 8 karakter, kombinasi huruf besar/kecil &amp; angka.</p>
            ...
            <div class="flex items-start gap-3 rounded-[14px] bg-blue-50 dark:bg-slate-700/50 p-4">
                <span class="mt-0.5 shrink-0 text-blue-700 dark:text-blue-400">
                    <x-player.icon name="shield" class="h-4 w-4" />
                </span>
                <label for="terms" class="flex items-start gap-2.5 text-sm text-slate-600 dark:text-dark-muted">
                    <input
                        type="checkbox"
                        id="terms"
                        name="terms"
                        value="1"
                        class="mt-0.5 h-4 w-4 shrink-0 rounded border-slate-300 text-blue-700 focus:ring-blue-200 dark:border-dark-border dark:bg-dark-bg dark:checked:bg-blue-600 dark:focus:ring-offset-dark-surface"
                        required
                        aria-required="true"
                    >
                    <span>
                        Dengan mendaftar, kamu setuju dengan
                        <a href="{{ route('terms') }}" target="_blank" rel="noopener" class="font-semibold text-blue-700 dark:text-blue-400 underline hover:text-blue-800 dark:hover:text-blue-300">Syarat &amp; Ketentuan</a>
                        dan
                        <a href="{{ route('privacy') }}" target="_blank" rel="noopener" class="font-semibold text-blue-700 dark:text-blue-400 underline hover:text-blue-800 dark:hover:text-blue-300">Kebijakan Privasi</a>
                    </span>
                </label>
            </div>
            @error('terms')
            ...
            <div class="relative py-1 text-center">
                <span class="relative z-10 bg-white dark:bg-dark-surface px-3 text-xs text-slate-400 dark:text-dark-muted">atau daftar dengan</span>
                <div class="absolute inset-x-0 top-1/2 h-px -translate-y-1/2 bg-slate-200 dark:bg-dark-border" aria-hidden="true"></div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                <a
                    ...
                    class="inline-flex h-12 items-center justify-center gap-2 rounded-[14px] border border-slate-200 dark:border-dark-border bg-white dark:bg-dark-surface text-sm font-semibold text-slate-700 dark:text-dark-text transition-all duration-200 hover:-translate-y-0.5 hover:bg-slate-50 dark:hover:bg-dark-surface-hover"
                >
                ...
                <a
                    ...
                    class="inline-flex h-12 items-center justify-center gap-2 rounded-[14px] border border-slate-200 dark:border-dark-border bg-white dark:bg-dark-surface text-sm font-semibold text-slate-700 dark:text-dark-text transition-all duration-200 hover:-translate-y-0.5 hover:bg-slate-50 dark:hover:bg-dark-surface-hover"
                >
                    <svg x-show="oauthLoading !== 'github'" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
