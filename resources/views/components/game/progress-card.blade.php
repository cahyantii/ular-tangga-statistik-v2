...
<div class="animate-fade-in-up rounded-2xl bg-white p-4 shadow-sm sm:p-5 dark:bg-slate-800">
    <h3 class="flex items-center gap-2 text-sm font-bold text-slate-700 dark:text-slate-200">
        <x-player.icon name="flag" class="h-4 w-4 text-primary-500 dark:text-primary-400" />
        Progress Permainan
    </h3>

    <div class="mt-3 flex items-end justify-between">
        <p class="text-sm text-slate-500 dark:text-slate-400">
            <span class="text-lg font-bold text-slate-800 dark:text-slate-100" id="progress-posisi">0</span>
