...
<div class="dice-3d-wrap mx-auto h-20 w-20 sm:h-24 sm:w-24 relative" id="{{ $id }}-wrap">
    ...
    <div id="{{ $id }}-disabled-overlay" class="absolute inset-0 z-10 hidden items-center justify-center rounded-2xl bg-slate-100/60 backdrop-blur-[2px] transition-all duration-300 dark:bg-slate-800/60">
        <svg class="h-8 w-8 text-slate-500 drop-shadow-sm dark:text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
