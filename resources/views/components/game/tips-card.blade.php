...
<div {{ $attributes->merge(['class' => 'animate-fade-in-up flex items-center gap-4 rounded-2xl bg-gradient-to-r from-accent-50 to-amber-50 p-4 shadow-sm sm:p-5 dark:from-accent-500/15 dark:to-amber-500/15']) }}>
