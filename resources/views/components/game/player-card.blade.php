...
<template id="player-card-template">
    <div class="player-card relative overflow-hidden rounded-2xl border-2 border-transparent bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-soft">
        ...
        <div class="relative mt-3 grid grid-cols-3 gap-2 text-center text-xs">
            ...
            <div>
                ...
                <p class="mt-0.5 flex items-center justify-center gap-1 font-bold text-primary-600">
            ...
            <div>
                ...
                <p class="mt-0.5 font-bold text-secondary-600" data-field="akurasi">&mdash;</p>
            </div>
        </div>
