...
<template id="player-card-template">
    <div class="player-card relative overflow-hidden rounded-2xl border-2 border-transparent bg-white dark:bg-dark-surface p-4 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-soft">
        ...
        <div class="relative flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
                <p class="truncate text-sm font-bold text-slate-800 dark:text-dark-text" data-field="nama"></p>
                <div class="mt-0.5 flex flex-wrap items-center gap-1.5">
                    <span class="me-badge hidden rounded-full bg-primary-50 dark:bg-primary-900/20 px-1.5 py-0.5 text-[10px] font-semibold text-primary-600 dark:text-primary-400">Anda</span>
        ...
        <div class="relative mt-3 h-2 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-800">
