...
@php
    $items = [
        ['icon' => 'star', 'tone' => 'bg-accent-50 text-accent-500 dark:bg-amber-950/60 dark:text-amber-400', 'label' => 'Total Skor', 'value' => number_format($current['total_skor'] ?? 0, 0, ',', '.')],
        ['icon' => 'trophy', 'tone' => 'bg-secondary-50 text-secondary-500 dark:bg-secondary-950/60 dark:text-secondary-400', 'label' => 'Total Menang', 'value' => $current['total_menang'] ?? 0],
        ['icon' => 'gamepad', 'tone' => 'bg-primary-50 text-primary-500 dark:bg-primary-950/60 dark:text-primary-400', 'label' => 'Total Main', 'value' => $current['total_main'] ?? 0],
        ['icon' => 'medal', 'tone' => 'bg-violet-50 text-violet-500 dark:bg-violet-950/60 dark:text-violet-400', 'label' => 'Rank Global', 'value' => $current ? "{$current['rank']} / {$totalPemain}" : 'Belum Peringkat'],
    ];
@endphp
