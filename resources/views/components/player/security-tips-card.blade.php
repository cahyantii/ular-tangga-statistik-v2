...
<div class="flex items-center gap-4 overflow-hidden rounded-3xl border border-primary-100 bg-primary-50 dark:border-primary-900/50 dark:bg-primary-900/20 p-5 sm:p-6">
    <div class="min-w-0 flex-1">
        <h3 class="flex items-center gap-2 text-sm font-bold text-slate-800 dark:text-dark-text">
            <x-player.icon name="lightbulb" class="h-4 w-4 text-accent-500" />
            Tips Keamanan
        </h3>
        <p class="mt-1.5 text-sm leading-relaxed text-slate-600 dark:text-dark-muted">{{ $tip }}</p>
    </div>
