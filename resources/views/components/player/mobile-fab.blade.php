...
<div class="fixed inset-x-3 bottom-3 z-40 mx-auto flex max-w-sm items-end justify-between gap-1 rounded-[28px] bg-white/95 p-2 shadow-soft-lg backdrop-blur-md dark:bg-slate-800/95 lg:hidden">
