...
<div class="animate-fade-in-up flex flex-col gap-5 rounded-2xl border border-secondary-200 bg-secondary-50 p-5 dark:border-secondary-500/30 dark:bg-secondary-500/10 sm:flex-row sm:items-center sm:justify-between sm:p-6">
    <div class="flex flex-col items-center gap-5 text-center sm:flex-row sm:text-left">
        ...
        <div class="min-w-0">
            ...
            <div class="mx-auto mt-2 h-2.5 w-56 max-w-full overflow-hidden rounded-full bg-white/70 dark:bg-slate-900/30 sm:mx-0 sm:w-72">
    ...
    <div class="flex items-center gap-3 sm:pl-4">
        ...
        <div class="text-right sm:text-left">
            <p class="text-sm font-bold text-slate-800 dark:text-slate-100">Terus bermain dan</p>
            <p class="text-sm font-bold text-slate-800 dark:text-slate-100">raih semua pencapaian!</p>
        </div>
    </div>
</div>
