...
<div class="animate-fade-in-up rounded-3xl bg-white dark:bg-dark-surface p-5 shadow-sm transition-shadow duration-300 hover:shadow-soft sm:p-6">
    ...
    <div class="mt-4 flex items-center justify-between gap-3">
        <div>
            <p class="text-3xl font-extrabold text-rose-500">
                {{ $streak }} <span class="text-sm font-semibold text-slate-400 dark:text-dark-muted">hari</span>
            </p>
            <p class="text-xs text-slate-400 dark:text-dark-muted">berturut-turut</p>
        </div>
    ...
    <p class="mt-3 text-xs font-medium text-slate-400 dark:text-dark-muted">
