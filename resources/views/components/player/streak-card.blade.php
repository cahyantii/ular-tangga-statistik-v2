    ...
    <div class="mt-4 flex items-center justify-between gap-3">
        <div>
            <p class="text-3xl font-extrabold text-rose-500 dark:text-rose-400">
                {{ $streak }} <span class="text-sm font-semibold text-slate-400 dark:text-slate-500">hari</span>
            </p>
            <p class="text-xs text-slate-400 dark:text-slate-500">berturut-turut</p>
        </div>
