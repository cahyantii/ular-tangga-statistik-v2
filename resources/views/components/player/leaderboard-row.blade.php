...
<tr class="transition-colors duration-200 {{ $highlight ? 'bg-gradient-to-r from-primary-50 to-violet-50' : 'hover:bg-slate-50' }}">
    <td class="px-4 py-3.5 sm:px-6">
        ...
        @else
            <span class="font-semibold text-slate-500">{{ $row['rank'] }}</span>
        @endif
    </td>
    ...
    <td class="px-4 py-3.5 sm:px-6">
        <div class="flex min-w-0 items-center gap-3">
            ...
            <span class="truncate font-semibold text-slate-800">{{ $row['nama'] }}</span>
        </div>
    </td>
    ...
    <td class="px-4 py-3.5 text-right sm:px-6">
        <span class="inline-flex items-center gap-1.5 font-bold text-accent-600">
    ...
    <td class="px-4 py-3.5 text-right sm:px-6">
        <span class="inline-flex items-center gap-1.5 font-semibold text-secondary-600">
    ...
    <td class="px-4 py-3.5 text-right sm:px-6">
        <span class="inline-flex items-center gap-1.5 font-semibold text-primary-600">
