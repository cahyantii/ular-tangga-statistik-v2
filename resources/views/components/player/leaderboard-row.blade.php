...
<tr class="transition-colors duration-200 {{ $highlight ? 'bg-gradient-to-r from-primary-50 to-violet-50 dark:from-primary-500/10 dark:to-violet-500/10' : 'hover:bg-slate-50 dark:hover:bg-slate-800' }}">
