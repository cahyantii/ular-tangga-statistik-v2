...
@php
    $items = [
        ['icon' => 'calendar', 'tone' => 'bg-violet-50 text-violet-500 dark:bg-violet-500/10', 'label' => 'Bergabung Sejak', 'value' => $user->created_at->translatedFormat('d F Y')],
        ['icon' => 'gamepad', 'tone' => 'bg-primary-50 text-primary-500 dark:bg-primary-500/10', 'label' => 'Total Permainan', 'value' => $summary['total_permainan']],
        ['icon' => 'chart-bar', 'tone' => 'bg-secondary-50 text-secondary-500 dark:bg-secondary-500/10', 'label' => 'Rata-rata Akurasi', 'value' => $summary['rata_rata_akurasi'].'%'],
        ['icon' => 'clock', 'tone' => 'bg-accent-50 text-accent-500 dark:bg-accent-500/10', 'label' => 'Waktu Belajar', 'value' => $summary['waktu_belajar_label']],
    ];
@endphp
