...
<div class="rounded-3xl bg-white p-5 shadow-sm transition-shadow duration-300 hover:shadow-soft dark:bg-slate-800 dark:shadow-none sm:p-6">
    ...
    <div class="grid grid-cols-1 items-center gap-6 sm:grid-cols-5">
        <div class="sm:col-span-3">
            ...
            <button
                ...
                class="mt-4 inline-flex items-center gap-2 rounded-xl border border-primary-100 bg-primary-50 px-4 py-2 text-sm font-semibold text-primary-600 transition hover:bg-primary-100 dark:border-primary-500/30 dark:bg-primary-500/10 dark:text-primary-400 dark:hover:bg-primary-500/20"
            >
    ...
    <x-player.modal name="sertifikat-preview">
        <div class="text-center">
            <p class="text-xs font-semibold uppercase tracking-wide text-primary-500 dark:text-primary-400">Pratinjau Sertifikat</p>
