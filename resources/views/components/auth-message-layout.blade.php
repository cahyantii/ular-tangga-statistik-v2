...
<html lang="id">
    ...
    <body class="overflow-x-hidden bg-[#F7FAFF] font-sans text-slate-800 antialiased">
            ...
            <nav class="mx-auto flex h-16 max-w-7xl items-center justify-center px-3 sm:h-20 sm:px-6 lg:px-8">
                <a href="{{ route('home') }}" class="flex items-center gap-2 sm:gap-4">
                    ...
                    <span class="leading-tight">
                        <span class="block text-sm font-bold text-slate-900 sm:text-base">Ular Tangga Statistik</span>
                        <span class="block text-[11px] text-slate-500 sm:text-xs">Belajar Statistik, Asyik &amp; Seru!</span>
                    </span>
                </a>
            </nav>
        </header>
        ...
        <main class="mx-auto flex min-h-[70vh] max-w-md items-center px-4 py-12">
            <div class="w-full animate-fade-in-up rounded-[28px] bg-white p-6 text-center shadow-[0_20px_60px_-15px_rgba(15,23,42,0.15)] sm:p-10">
                {{ $slot }}
            </div>
        </main>

        <footer class="border-t border-slate-100">
            <div class="mx-auto flex max-w-7xl flex-col items-center justify-center gap-2 px-4 py-8 text-center text-sm text-slate-500 sm:px-6 lg:px-8">
