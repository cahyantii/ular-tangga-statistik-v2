            ...
            <div class="group rounded-3xl bg-white p-5 shadow-sm transition-shadow duration-300 hover:shadow-soft dark:bg-slate-800 sm:p-6 lg:col-span-2">
                ...
                <div class="mt-5 flex flex-col gap-6 lg:flex-row lg:items-start">
                    <div class="flex shrink-0 flex-col items-center gap-2 lg:w-36">
                        <div class="relative w-full rounded-2xl bg-primary-50 px-3.5 py-2.5 text-center text-xs font-medium leading-relaxed text-slate-600 shadow-sm dark:bg-primary-950/60 dark:text-slate-300">
                            Belajar sedikit demi sedikit, hasil luar biasa akan mengikutimu!
                            <span class="absolute -bottom-1.5 left-1/2 h-3 w-3 -translate-x-1/2 rotate-45 bg-primary-50 dark:bg-primary-950/60" aria-hidden="true"></span>
                        </div>
                ...
                <div class="mt-6 flex items-center gap-3 rounded-2xl bg-primary-50 p-4 text-sm dark:bg-primary-950/40">
