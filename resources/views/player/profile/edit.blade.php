<x-player-layout>
    <x-slot name="header">
        <h1 class="text-xl font-bold text-slate-800 dark:text-dark-text sm:text-2xl">Profil</h1>
        <p class="mt-0.5 text-sm text-slate-500 dark:text-dark-muted">Kelola informasi akun dan keamananmu &#10024;</p>
    </x-slot>
