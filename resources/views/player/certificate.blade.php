<x-player-layout>
    ...
    @if ($certificate)
        <div class="cert-earned-banner mx-auto max-w-lg rounded-3xl border-2 p-6 text-center shadow-sm sm:p-8">
            ...
            <p class="mt-1 text-sm text-slate-600 dark:text-slate-300">Nomor: {{ $certificate->nomor_sertifikat }}</p>
            <p class="text-sm text-slate-600 dark:text-slate-300">Terbit: {{ $certificate->issued_at->translatedFormat('d F Y') }}</p>
    ...
    @else
        <div class="space-y-6">
            {{-- Hero --}}
            <div class="cert-card cert-card--white flex flex-col items-center gap-6 rounded-3xl p-6 text-center shadow-sm sm:p-8 lg:flex-row lg:justify-between lg:text-left">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                {{-- Timeline syarat --}}
                <div class="cert-card cert-card--progress rounded-3xl p-5 shadow-sm sm:p-6 lg:col-span-2 lg:p-7">
                    <div>
